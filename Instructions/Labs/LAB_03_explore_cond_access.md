...
# Laboratorio: Explorar la administración de accesos en Azure AD con Conditional
...
#### Tarea 1: En esta tarea, como administrador, restablecerá la contraseña del usuario Debra Berger.  Este paso es necesario para poder iniciar sesión como el usuario en las siguientes tareas.
...
#### Tarea 2:  En esta tarea, aprenderá el proceso de creación de una directiva de acceso condicional en Azure AD.
...
1. Ahora intentará iniciar sesión en una aplicación que cumpla con los criterios de la MFA.  Abra Microsoft Edge y, en la barra de direcciones, escriba https://portal.azure.com.
...
1. Se abrirá una nueva ventana, asegúrese de que su país o región está seleccionado, luego escriba el número de teléfono móvil que desea utilizar, asegúrese de que **Enviarme un código por mensaje de texto** esté seleccionado y luego presione **Siguiente**.  La pantalla mostrará: "SMS verificado. El teléfono se ha registrado correctamente".  Seleccione **Siguiente** y luego **Listo**,  esto completará el único proceso de registro.
