...
1. Seleccione **Editar** directiva en la parte superior de la ventana.
    ...
    1. Revise la configuración de la directiva.  Seleccionar **Requiere que los usuarios apliquen una etiqueta a su correo electrónico o sus documentos**.  Seleccione **Siguiente** en la parte inferior de la página.
    1. Lea la descripción en "Aplicar una etiqueta predeterminada a los documentos".  Observe que no hay ninguna etiqueta predeterminada. En el campo Etiqueta predeterminada, seleccione la flecha abajo y, a continuación, seleccione **General/Todos los empleados (sin restricciones)** .  Seleccione **Siguiente** en la parte inferior de la página.
...
1. Seleccione **+ Nuevo documento en blanco** y luego escriba algo de texto en la página.  En la barra azul de la parte superior de la página, seleccione la flecha hacia abajo que hay junto a las palabras DocumentoXX: Guardado y, en el cuadro Nombre de archivo, escriba **Etiqueta:Prueba** y pulse la tecla **Entrar** en el teclado.
...
### <a name="demo-part-3-optional"></a>Demo, parte 3 (opcional)
