...
Configure un área de trabajo de Log Analytics y, una vez creada, cree una instancia de Microsoft Sentinel y agréguele el área de trabajo de Log Analytics.
